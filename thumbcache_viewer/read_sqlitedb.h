...
struct PROPERTY_INFO_STATUS
{
	wchar_t *file_extension;
	wchar_t *item_path_display;
...
int WINAPIV c_CheckPropertyInfoCallback( void *arg, int argc, char **argv, char **azColName );
...
int WINAPI s_CheckPropertyInfoCallback( void *arg, int argc, char **argv, char **azColName );
