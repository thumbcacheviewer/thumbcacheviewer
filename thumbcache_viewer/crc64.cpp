...
{
	// CRC-64 lookup table. These values were found in thumbcache.dll.
	static unsigned long long lookup_table[ 256 ] = {
	...
	while ( length-- > 0 )
	{
		init_crc = lookup_table[ ( init_crc ^ *buf++ ) & 0xFF ] ^ ( init_crc >> 8 );
	}
